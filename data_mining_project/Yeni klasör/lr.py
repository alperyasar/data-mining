...
def lr():
    ...
    print("old logistic Regression algorithm accurance average : ",x)
    print("*"*100,"\n")
    print("#"*100)
    print("#"*100,"\n\n")
    ...
    x = (printScreen(y_test1, pred) + x) /2
    print("Improved logistic Regression algorithm accurance average : ",x)
    print("*"*100,"\n")
    improvedByScored()
...
def improvedByScored():
    ...
    print("Improved logistic Regression by Scored algorithm accurance average : ",x)
    print("*"*100,"\n")
